                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="form-group">
                                            ...
                                            <input name="password" value={formData.password} onChange={handleInputChange} placeholder='Enter password' type='password' className="form-control"></input>
                                        </div>
                                    </div>
                                </div>
                            </div>
